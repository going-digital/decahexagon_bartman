...
/* Normal/hyper Hexagon / Hexagoner / Hexagonest, integer-speed dt=1. Score is the already incremented tick
 * counter. pc_progress coordinates stage handoffs around this selector. */
typedef struct {
    uint32_t wave;
    uint8_t stage; /* 0=Hexagon, 1=Hexagoner, 2=Hexagonest; normal/hyper selectors share this stage. */
    uint8_t hyper_entry; /* One-shot opener override, consumed at scheduling. */
