...
#ifndef TRACKLOADER
#define TRACKLOADER 0
#endif
#if TRACKLOADER && BUILD_DEBUG
#error "The resident platform currently requires BUILD_DEBUG=0"
#endif
...
#if TRACKLOADER && MUSIC_FIB_STREAM && !PCM_EXTERNAL_ONLY
#error "The resident platform requires external-only music"
#endif
