#!/usr/bin/env python3
"""Hexagon / Hexagoner selectors versus saved original-machine-code traces."""
...
assert len(actual)==len(rows)==122880
...
print('122880 Hexagon/Hexagoner native selector cases matched')
