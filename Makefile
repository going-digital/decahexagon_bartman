...
cpp_sources :=
cpp_objects :=
c_sources := main.c system.c coplist.c blitter.c trig.c audio.c input.c game.c patterns.c render.c hud.c pc_core.c pc_world.c pc_waves.c pc_schedule.c pc_progress.c pc_morph.c pc_projection.c pc_palette.c render_clip.c support/gcc8_c_support.c
...
c_sources += tests/core_checks.c tests/wave_checks.c tests/schedule_checks.c tests/progression_checks.c tests/clip_checks.c
...
.PHONY: test
HOST_CC ?= cc
test: test-palette test-progression
	@mkdir -p out
	$(HOST_CC) -std=c99 -O2 -Wall -Wextra -Werror pc_core.c pc_world.c pc_waves.c pc_schedule.c pc_progress.c pc_morph.c pc_projection.c render_clip.c tests/core_checks.c tests/wave_checks.c tests/schedule_checks.c tests/progression_checks.c tests/clip_checks.c tests/core_test.c -o out/core_test
	./out/core_test
